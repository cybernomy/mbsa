...
public class FinPeriod extends com.mg.framework.service.PersistentObjectHibernate
  ...
  /**
   * @param Pname - Наименование фин. периода
   */
  ...
  /**
   * @param Datefrom - Дата начала фин. периода
   */
  ...
  /**
   * @param Dateto - Дата окончания фин. периода
   */
  ...
  /**
   * @param Whoclosed - Кто закрыл фин.период
   */
  ...
  /**
   * @param Dateclose - дата закрытия фин. периода
   */
