...
/**
 * @author hbm2java
 * @version $Id: OperationPurpose.java,v 1.3 2006/06/14 07:52:52 leonova Exp $
 */
@DataItemName("CRM.OperationPurpose")
public class OperationPurpose extends
	...
	/** constructor with id */
	public OperationPurpose(java.lang.Integer Id) {
		this.Id = Id;
	}
