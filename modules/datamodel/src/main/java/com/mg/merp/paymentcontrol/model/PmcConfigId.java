...
public class PmcConfigId extends com.mg.framework.service.PersistentObjectHibernate implements java.io.Serializable {
 ...
 private java.lang.Short CurrencyPrec;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PmcConfigId) ) return false;
 ...
 && (this.getCurrency()==castOther.getCurrency()) || (this.getCurrency()==null ? false : (castOther.getCurrency()==null ? false : this.getCurrency().equals(castOther.getCurrency())))
 && (this.getCurRateType()==castOther.getCurRateType()) || (this.getCurRateType()==null ? false : (castOther.getCurRateType()==null ? false : this.getCurRateType().equals(castOther.getCurRateType())))
 && (this.getCurRateAuthority()==castOther.getCurRateAuthority()) || (this.getCurRateAuthority()==null ? false : (castOther.getCurRateAuthority()==null ? false : this.getCurRateAuthority().equals(castOther.getCurRateAuthority())))
