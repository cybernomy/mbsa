...
/**
 * Базовый класс BAi выполнения настраиваемого действия. Класс BAi должен реализовывать следующий
 * метод <code>protected String doPerform() throws Exception</code>. В случае успешного выполнения
 * необходимо вызвать {@link #complete(Void)}, если необходимо прервать выполнение действия
 * необходимо вызвать {@link #abort()}.
 *
 *
 ...
 *  	UIUtils.showAlert(Alert.MessageType.QUESTION_MESSAGE, "Foo", "foo", "Yes", "No", new
 * AlertListener() {
