...
/**
 * Диалоговая сессия, служит для хранения произвольной информации в процессе интерактивного
 * взаимодействия с пользователем, доступна в событиях beforeOutput и afterInput для форм поддержки
 *
