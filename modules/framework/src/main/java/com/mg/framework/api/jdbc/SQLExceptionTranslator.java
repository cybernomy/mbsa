...
/**
 * Interface to be implemented by classes that can translate between SQLExceptions and our data
 * access strategy-agnostic {@link com.mg.framework.api.DataAccessException DataAccessException}.
 *
 * <p>Implementations can be generic (for example, using SQLState codes for JDBC) or proprietary
