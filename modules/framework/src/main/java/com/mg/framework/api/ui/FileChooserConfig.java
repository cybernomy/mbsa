...
public class FileChooserConfig implements Serializable {
   ...
   *
   * @param acceptAllFileFilterUsed <code>true</code> if the <code>AcceptAllFileFilter</code> should
   ...
   *
   * @param approveButtonToolTipText the approve button tool tip text of this file chooser
   *                                 configuration
   */
  ...
  /**
   * Determines if control buttons are to be shown. However, this is ultimately determined by the
   * Look and Feels.
   *
   * @param controlsShown <code>false</code> if control buttons should not be shown; otherwise,
   *                      <code>true</code>
   */
   ...
   *
   * @param fileHidingEnabled <code>true</code> if file hiding is enabled, <code>false</code>
   *                          otherwise
   */
  ...
  /**
   * Returns the current file selection mode. The default is <code>FileSelectionMode.FILES_ONLY</code>.
   *
  ...
  /**
   * Sets file selection mode which allows the user to just select files, just select directories,
   * or select both files and directories. The default is <code>FileSelectionMode.FILES_ONLY</code>.
   *
  ...
  /**
   * Configuration information for a file filter. A file filter can be used on a file chooser to
