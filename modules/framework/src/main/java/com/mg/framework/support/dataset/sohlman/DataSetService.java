...
/**
 * DataSetService contains commonly used methods for DataSet library. All methods are static
 *
...
public class DataSetService {
   ...
   * @return boolean false if position is larger that size of StringBuffer othervice true or String
   * is null
   */
  ...
  /**
   * Method compareComparables compares two comparables and checks also null values. null is smaller
   * than not null value.
   *
   * @return int
   */
