...
/**
 * Абстрактная реализация бизнес-компонента основанного на сервисах не имеющих состояние во время
 * выполнения (stateless)
 *
 * @author Oleg V. Safonov
 * @version $Id: AbstractPOJOBusinessObjectStatelessServiceBean.java,v 1.4 2006/09/28 12:24:12
 *          safonov Exp $
 */
