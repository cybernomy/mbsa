 ...
 * contract. The PreparedStatementCreator callback interface creates a prepared statement given a
 * Connection provided by this class, providing SQL and any necessary parameters. The
 ...
 *
 * <p>The motivation and design of this class is discussed in detail in <a
 ...
 * SQLExceptionTranslator interface, it isn't necessary to subclass it. All SQL issued by this class
 * is logged.
 *
...
public class JdbcTemplate implements JdbcOperations {
   ...
   * @param pss object that knows how to set values on the prepared statement. If this is null, the
   *            SQL will be assumed to contain no bind parameters.
  ...
  /**
   * Actual creation of a java.util.LinkedHashMap. In separate inner class to avoid runtime
   * dependency on JDK 1.4.
   */
