...
public interface SQLExceptionTranslatorManager {
  ...
  /**
   * регистрация траслятора, становится первым в списке обработчиков, т.о. возможно переопределить
   * поведение трасляторов добавив свой траслятор после инсталяции переопределяемого
   *
