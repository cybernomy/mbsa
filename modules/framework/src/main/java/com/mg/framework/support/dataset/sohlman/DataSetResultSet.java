 ...
 * @version 2003-02-03
 */
abstract class DataSetResultSet implements ResultSet {
  ...
  /**
   * @see java.sql.ResultSet#getBigDecimal(int, int) Not implemented
   * @deprecated
   */
  ...
  /**
   * @see java.sql.ResultSet#getAsciiStream(int) (Not implemented)
   */
