...
/**
 * With KeyColumnsAction object is possible to define which columns act like key columns. If these
 * columns are changed DataSet perform Delete & Insert operation in it's buffers.<br>
 *
 * @author Sampsa Sohlman
 * @version 2001-09-17
 */
public class KeyColumnsAction implements ModifyAction {
  /**
   * List of columns
   */
   ...
   * Constructor
   *
   * @param ai_columns Column numbers that are doing the updates. 0 is first column.
   */
