...
public interface FileStoreHandler extends Serializable {
   ...
   *
   * @param filePath полный локальный путь к файлу, или <code>null</code> если среда клиента не
   *                 предоставляет информацию о путях
   * @param fileName имя файла, или <code>null</code> если среда клиента не предоставляет информацию
   *                 об именах
   */
