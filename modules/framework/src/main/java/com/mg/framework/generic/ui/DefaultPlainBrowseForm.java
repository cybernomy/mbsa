...
public class DefaultPlainBrowseForm extends AbstractSearchForm implements MaintenanceBrowseForm, MasterModelListener {
  ...
  /**
   * создание формы ограничений, в базовой реализации создает форму по имени {@link
   * #restrictionFormName}
   *
  ...
  /**
   * возвращает список полей по умолчанию отображаемых в браузере, возможно переопределение в классе
   * наследнике
   *
   * @return список полей
   */
