...
/**
 * Some applications need to create criteria queries in "detached mode". All methods have the same
 * semantics and behavior as the corresponding methods of the <literal>Criteria</literal>
 * interface.
 *
 * <p>For example:
 * <pre>
