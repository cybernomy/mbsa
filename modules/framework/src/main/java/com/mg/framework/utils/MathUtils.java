...
public class MathUtils {
   ...
   * @return -1 если <code>value</code> меньше нуля, 0 если <code>value</code> равно нулю, 1 если
   * <code>value</code> больше нуля
   */
   ...
   *
   * @param value значение
   * @return -1 если <code>value</code> меньше нуля, 0 если <code>value</code> равно нулю или
   * <code>null</code>, 1 если <code>value</code> больше нуля
   */
   ...
   * @return произведение, или <code>null</code> если <code>multiplicand == null</code> или
   * <code>multiplier == null</code>
   */
   ...
   * @param rc     контекст округления
   * @return сумма, или <code>null</code> если <code>augend == null</code> или <code>addend ==
   * null</code>
   */
   ...
   * @param rc       контекст округления
   * @return частное, или <code>null</code> если <code>dividend == null</code> или <code>divisor ==
   * null</code>
   */
   ...
   * @param rc         контекст округления
   * @return разность, или <code>null</code> если <code>minuend == null</code> или <code>subtrahend
   * == null</code>
   */
   ...
   * @param addend второе слагаемое
   * @param rc     контекст округления
   * @return сумма, или <code>addend</code> если <code>augend == null</code>, или
   * <code>augend</code> если <code>addend == null</code>
   */
   ...
   * @param subtrahend вычитаемое
   * @param rc         контекст округления
   * @return разность, или <code>subtrahend</code> если <code>minuend == null</code>,
   * <code>minuend</code> или <code>subtrahend == null</code>
   */
