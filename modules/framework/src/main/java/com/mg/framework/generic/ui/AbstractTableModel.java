...
/**
 * The <code>AbstractTableModel</code> class provides a default implementation formost of the
 * methods in the <code>TableModel</code> interface. In most cases developer will subclass
 * <code>AbstractTableModel</code> to implement his own table model.
 *
...
public abstract class AbstractTableModel implements TableModel, Serializable {
   ...
   * rows may also have changed and the <code>Table</code> should redraw the table from scratch. The
  ...
  /**
   * Notifies all listeners that rows in the range <code>firstRow</code> to <code>lastRow</code>,
  ...
  /**
   * Notifies all listeners that the value of the cell at row <code>row</code> and column
