...
public interface Label extends Widget {
  ...
  /**
   * атрибут вертикального выравнивания, может иметь значения: </br>bottom </br>center </br>top
   */
  final static String VERTICAL_ALIGNMENT = "verticalAlignment";

  /**
   * атрибут горизонтального выравнивания, может иметь значения: </br>left </br>center </br>right
   * </br>leading </br>trailing
   */
