...
/**
 * Базовый интерфейс всех контроллеров интерактивных форм. Используется для взаимодействия с видом.
 *
...
public interface Controller {
  ...
  /**
   * Получить значение поля контроллера. Используется видом для заполнения элементов формы.
   *
   * @param name имя поля
  ...
  /**
   * Установить значение поля контроллера. Используется видом для заполнения поля значением из
   * элемента формы.
   *
   * @param name  имя поля
  ...
  /**
   * Получить метаданные поля контроллера. Используется видом для идентификации необходимой
   * метаинформации используемой при создании элементов формы.
   *
   * @param name имя поля
  ...
  /**
   * Вызов обработчика контроллера. Используется видом для вызова обработчика установленного у
   * элемента формы.
   *
