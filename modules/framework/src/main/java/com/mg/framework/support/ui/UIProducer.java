...
public class UIProducer {
  ...
  /**
   * создает форму по наименованию описателя, описатель формы должен быть доступен текущему
   * загрузчику ресурсов, если описатель не нейден будет сгенерирована ИС.
   *
  ...
  /**
   * создает форму по наименованию описателя, используется генератор макросов, описатель формы
   * должен быть доступен текущему загрузчику ресурсов, если описатель не нейден будет сгенерирована
   * ИС.
   *
   * @param formName            имя формы
