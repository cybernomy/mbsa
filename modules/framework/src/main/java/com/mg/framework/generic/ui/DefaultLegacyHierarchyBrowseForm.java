...
public class DefaultLegacyHierarchyBrowseForm extends DefaultLegacyPlainBrowseForm {
  ...
  /**
   * Метод устанавливает ссылку на объект мастер. Необходимо переопределить в наследнике. Например:
   * <code>uiProperties.put("FolderId", master)</code>
   *
  ...
  /**
   * Загрузка списка папок текщего сервиса. Необходимо переопределить в наследнике если сервис не
   * реализует метод loadFolders()
   *
