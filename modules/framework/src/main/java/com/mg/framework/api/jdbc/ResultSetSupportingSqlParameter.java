...
/**
 * Common base class for ResultSet-supporting SqlParameters like SqlOutParameter and
 * SqlReturnResultSet.
 *
...
public class ResultSetSupportingSqlParameter<T> extends SqlParameter {
  ...
  /**
   * Return a new instance of the implementation of a RowCallbackHandler, usable for returned
   * ResultSets. This implementation invokes a given RowMapper via the RowMapperResultReader
   * adapter, respectively returns a given RowCallbackHandler directly.
   *
