...
/**
 * This abstract class is extended by classes that provide a web resource which is primarily
 * generated in memory as a byte array or into an output stream. <p/> An input stream and a file
 * representation of the byte array created by the subclass are provided by this class. <p/>
 *
