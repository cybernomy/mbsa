...
/**
 * The <code>Color</code> class is used to encapsulate colors in the default sRGB color space or
 * colors in arbitrary color spaces identified by a {@link java.awt.color.ColorSpace}.  Every color
 * has an implicit alpha value of 255 or an explicit one provided in the constructor.  The alpha
 * value defines the transparency of a color and can be represented by a integer value in the range
 * 0&nbsp;-&nbsp;255. An alpha value of 255 means that the color is completely opaque and an alpha
 * value of 0 means that the color is completely transparent. When constructing a <code>Color</code>
 * with an explicit alpha or getting the color/alpha components of a <code>Color</code>, the color
 * components are never premultiplied by the alpha component. <p> The default color space for the
 * Java 2D(tm) API is sRGB, a proposed standard RGB color space.  For further information on sRGB,
 * see <A href="http://www.w3.org/pub/WWW/Graphics/Color/sRGB.html">
 * http://www.w3.org/pub/WWW/Graphics/Color/sRGB.html </A>. <p>
 *
...
public class Color implements Serializable {
   ...
   * @throws IllegalArgumentException if <code>r</code>, <code>g</code>, <code>b</code> or
   ...
   * The actual color used in rendering depends on finding the best match given the color space
   ...
   * java.awt.image.ColorModel}. (Bits 24-31 are alpha, 16-23 are red, 8-15 are green, 0-7 are
   * blue).
   *
