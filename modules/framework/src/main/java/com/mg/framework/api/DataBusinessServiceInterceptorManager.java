...
public interface DataBusinessServiceInterceptorManager extends Serializable {
  ...
  /**
   * вызов всех перехватчиков для бизнес-компонента на событие "копирование", стандартное действие
   * не будет выполнено если хотя бы один перехватчик потребует отмены стандартного действия
   *
