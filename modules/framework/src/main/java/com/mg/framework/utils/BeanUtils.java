...
public class BeanUtils {
  ...
  /**
   * получить значение идентификатора сущности, данный метод позволяет получить идентификатор
   * сущности которая не принадлежит текущей сессии в отличии от метода {@link
   * com.mg.framework.api.orm.PersistentObject#getPrimaryKey()} который позволяет получить
   * идентификатор только для сущностей принадлежащих текущей сессии
   *
   * @param bean сущность
