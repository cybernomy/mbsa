...
public interface MenuItem extends Widget {
  ...
  /**
   * атрибут тип переключателя, может иметь следующие значения: {@link #TOGGLE_NONE}, {@link
   * #TOGGLE_CHECK_BOX}, {@link #TOGGLE_RADIO_BUTTON}
   *
   * @since 4.0.6
   */
  ...
  /**
   * пункт меню имеет тип переключателя Radio button, не поддерживается в текущей версии
   */
