...
/**
 * Реализация API критериев, не использовать данный класс в прикладном коде, для создания критериев
 * использовать {@link com.mg.framework.api.orm.OrmTemplate#createCriteria}
 *
