 ...
 *
 * @author Oleg V. Safonov $Id: PersistentObject.java,v 1.5 2007/08/16 13:26:40 safonov Exp $
 */
public interface PersistentObject {
  ...
  /**
   * копирование объекта сущности, если <code>attributes</code> содержит значения, то будут
   * установлены соответсвующие атрибуты созданной сущности
   *
   * @param attributes карта наименований свойств объекта и значений, может быть <code>null</code>
   * @return копия объекта сущности или <code>null</code> если копирование не удалось или не
   * реализовано
   */
