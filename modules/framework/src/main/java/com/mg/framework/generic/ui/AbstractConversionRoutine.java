...
public abstract class AbstractConversionRoutine<S, U> implements ConversionRoutine<S, U>, Serializable {
  ...
  /**
   * реализация конвертации из значения пользовательского интерфейса в значение обрабатываемое
   * системой, должен быть переопределен в классе реализующем конвертацию
   *
  ...
  /**
   * реализация конвертации из значения обрабатываемого системой в значение для пользовательского
   * интерфейса, должен быть переопределен в классе реализующем конвертацию
   *
