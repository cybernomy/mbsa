 ...
 *
 * <p>Must declare a RowCallbackHandler to handle any returned rows. No additional properties:
 * instanceof will be used to check for such types.
 *
 * <p>Returned ResultSets - like all stored procedure parameters - must have names.
 *
