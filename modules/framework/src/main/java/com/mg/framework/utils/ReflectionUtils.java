...
public class ReflectionUtils {
  ...
  /**
   * Finds a specific method of an object given the number of parameters. Returns the method or null
   * if not found
   */
  ...
  /**
   * Finds the getter of a specific attribute in an object. Returns the method for accessing the
  ...
  /**
   * Finds the setter of a specific attribute without knowing its type. Returns the method for
   * accessing the attribute, null otherwise
   */
   ...
   * method. <p>Checks <code>Class.getDeclaredMethod</code>, cascading upwards to all superclasses.
   *
