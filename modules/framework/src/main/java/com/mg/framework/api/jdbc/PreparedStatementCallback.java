 ...
 * number of operations on a single PreparedStatement, for example a single executeUpdate call or
 * repeated executeUpdate calls with varying parameters.
 *
...
public interface PreparedStatementCallback {
  ...
  /**
   * Gets called by JdbcTemplate.execute with an active JDBC PreparedStatement. Does not need to
