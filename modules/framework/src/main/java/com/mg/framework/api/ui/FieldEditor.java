...
public interface FieldEditor {
	...
	/**
	 * атрибут признак наличия текстовой метки для редактора, имеет значение <code>Boolean</code>,
	 * по умолчанию метка показывается
	 */
	final static String SHOW_LABEL = "showLabel";

	/**
	 * атрибут ссылка на элемент данных, должен содержать имя элемента данных, позволяет переопределить
	 * установленный элемент данных в модели
	 */
