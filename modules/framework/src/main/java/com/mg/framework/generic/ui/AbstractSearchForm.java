...
/**
 * Абстрактный класс формы поиска сущностей, как правило используется в паре с {@link
 * com.mg.framework.api.ui.SearchHelp SearchHelp}. Содержит базовую функциональность для работы с
