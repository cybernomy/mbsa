...
/**
 * Реализация сложной формы поддержки для бизнес-компонента, как правило применяется для форм
 * содержащих зависимые данные, например список спецификаций документа зависит от заголовка
 * документа.
 *
