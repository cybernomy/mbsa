...
public class DnDTreeData extends DnDData {
  ...
  /**
   * получить список веток дерева, как правило, если дерево является приемником, то содержится один
   * элемент, если дерево является источником, то возможно несколько элементов перетаскиваемых при
   * операции
   *
   * @return список веток
   */
