...
/**
 * <p>Master inteface for all WriteEngine interfaces. </p> <p>This is designed for mainly for future
 * use</p>
 *
...
public interface ReadEngine {
   ...
   *
   * @param a_ColumnsInfo which defines type of row. If row differs then {@link DataSetException
   *                      DataSetException} is thrown. If value is null then It will genereate new
   *                      RowInfo.
   ...
   *
   * <B>It is important that this is return null value some point, othervice there might be eternal
   * loop in application.</B>
   *
