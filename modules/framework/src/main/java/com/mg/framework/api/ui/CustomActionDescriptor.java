...
/**
 * Настраиваемое действие, используется для создания точек вызова дополнительной функциональности
 * в стандартных формах и элементах пользовательского интерфейса
 * 
...
public interface CustomActionDescriptor {
	...
	/**
	 * признак обновления содержимого элемента пользовательского интерфейса из которого
	 * было вызвано действие
	 * 
