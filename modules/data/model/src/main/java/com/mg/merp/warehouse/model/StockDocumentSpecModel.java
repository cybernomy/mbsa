...
public class StockDocumentSpecModel extends com.mg.merp.document.model.DocSpecModel implements java.io.Serializable {
    ...
    public StockDocumentSpecModel(TimePeriodKind ShelfLifeMeas) {
        super(ShelfLifeMeas);        
    }
    public StockDocumentSpecModel(Catalog Catalog, Contractor DstMol, Contractor SrcMol, DocHeadModel DocHeadModel, Measure Measure2, SysClient SysClient, Contractor DstStock, Measure Measure1, Contractor SrcStock, PriceListSpec PriceListSpec, BigDecimal Quantity, BigDecimal Price, BigDecimal Summa, BigDecimal Price1, BigDecimal Summa1, BigDecimal Weight, BigDecimal Volume, Date BestBefore, TaxGroup TaxGroup, Date ProductionDate, BigDecimal ShelfLife, TimePeriodKind ShelfLifeMeas, BigDecimal Quantity2, String Comment, Contractor Contractor, BigDecimal Cost, BigDecimal Discount, BigDecimal PriceWithDiscount, BigDecimal SummaWithDiscount, BigDecimal DocDiscount) {
