...
public class LinkProblemSolution extends com.mg.merp.core.model.AbstractEntity implements java.io.Serializable {
    ...
    @EmbeddedId
    @AttributeOverrides({ @AttributeOverride(name = "CrmSolution", column = @Column(name = "SOLUTION_ID", nullable = false)), @AttributeOverride(name = "CrmProblem", column = @Column(name = "PROBLEM_ID", nullable = false)), @AttributeOverride(name = "SysClient", column = @Column(name = "CLIENT_ID", nullable = false)) })
