...
public class Strings extends com.mg.merp.core.model.AbstractEntity implements java.io.Serializable {
    ...
    @EmbeddedId
    @AttributeOverrides({ @AttributeOverride(name = "Section", column = @Column(name = "SECTION", columnDefinition = "INTEGER")), @AttributeOverride(name = "Val", column = @Column(name = "VAL", columnDefinition = "INTEGER")) })
