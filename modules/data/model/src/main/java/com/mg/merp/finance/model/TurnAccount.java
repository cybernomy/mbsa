 ...
 */
public class TurnAccount extends PersistentObjectHibernate implements Serializable {
   ...
   * constructor with id
   */
  public TurnAccount(java.lang.Integer Id) {
    this.id = Id;
  }
  ...
  public void setAccount(com.mg.merp.finance.model.Account Finaccount) {
    this.account = Finaccount;
  }
  ...
  /**
   * @param incomeCurPlan The incomeCurPlan to set.
   */
  ...
  /**
   * @param incomeNat The incomeNat to set.
   */
  ...
  /**
   * @param incomeNatPlan The incomeNatPlan to set.
   */
  ...
  /**
   * @param outcomeCur The outcomeCur to set.
   */
  ...
  /**
   * @param outcomeCurPlan The outcomeCurPlan to set.
   */
  ...
  /**
   * @param outcomeNat The outcomeNat to set.
   */
  ...
  /**
   * @param outcomeNatPlan The outcomeNatPlan to set.
   */
  ...
  /**
   * @param remnEndCur The remnEndCur to set.
   */
  ...
  /**
   * @param remnEndCurPlan The remnEndCurPlan to set.
   */
  ...
  /**
   * @param remnEndNat The remnEndNat to set.
   */
  ...
  /**
   * @param remnEndNatPlan The remnEndNatPlan to set.
   */
