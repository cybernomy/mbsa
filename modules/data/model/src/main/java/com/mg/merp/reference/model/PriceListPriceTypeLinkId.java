...
public class PriceListPriceTypeLinkId extends com.mg.framework.service.PersistentObjectHibernate implements java.io.Serializable {
   ...
   */
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof PriceListPriceTypeLinkId))
            return false;
        PriceListPriceTypeLinkId castOther = (PriceListPriceTypeLinkId) other;
        return (this.getAlgRepository() == castOther.getAlgRepository()) || (this.getAlgRepository() == null ? false : (castOther.getAlgRepository() == null ? false : this.getAlgRepository().equals(castOther.getAlgRepository()))) && (this.getPriceType() == castOther.getPriceType()) || (this.getPriceType() == null ? false : (castOther.getPriceType() == null ? false : this.getPriceType().equals(castOther.getPriceType()))) && (this.getSysClient() == castOther.getSysClient()) || (this.getSysClient() == null ? false : (castOther.getSysClient() == null ? false : this.getSysClient().equals(castOther.getSysClient()))) && (this.getPriceListHead() == castOther.getPriceListHead()) || (this.getPriceListHead() == null ? false : (castOther.getPriceListHead() == null ? false : this.getPriceListHead().equals(castOther.getPriceListHead()))) && (this.getPriority() == castOther.getPriority()) || (this.getPriority() == null ? false : (castOther.getPriority() == null ? false : this.getPriority().equals(castOther.getPriority()))) && (this.getRelativePercent() == castOther.getRelativePercent()) || (this.getRelativePercent() == null ? false : (castOther.getRelativePercent() == null ? false : this.getRelativePercent().equals(castOther.getRelativePercent()))) && (this.getFormula() == castOther.getFormula()) || (this.getFormula() == null ? false : (castOther.getFormula() == null ? false : this.getFormula().equals(castOther.getFormula()))) && (this.getId() == castOther.getId()) || (this.getId() == null ? false : (castOther.getId() == null ? false : this.getId().equals(castOther.getId())));
    }
