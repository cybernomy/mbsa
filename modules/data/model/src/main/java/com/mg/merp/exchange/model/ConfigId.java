...
public class ConfigId extends com.mg.framework.service.PersistentObjectHibernate implements java.io.Serializable {
   ...
   */
    ...
    public boolean equals(Object other) {
        ...
        return (this.getSysClient() == castOther.getSysClient()) || (this.getSysClient() == null ? false : (castOther.getSysClient() == null ? false : this.getSysClient().equals(castOther.getSysClient()))) && (this.getSiteCode() == castOther.getSiteCode()) || (this.getSiteCode() == null ? false : (castOther.getSiteCode() == null ? false : this.getSiteCode().equals(castOther.getSiteCode())));
    }
