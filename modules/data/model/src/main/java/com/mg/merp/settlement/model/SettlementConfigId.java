...
public class SettlementConfigId extends com.mg.framework.service.PersistentObjectHibernate implements java.io.Serializable {
   ...
   */
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof SettlementConfigId))
            return false;
        SettlementConfigId castOther = (SettlementConfigId) other;
        return (this.getCurrency() == castOther.getCurrency()) || (this.getCurrency() == null ? false : (castOther.getCurrency() == null ? false : this.getCurrency().equals(castOther.getCurrency()))) && (this.getSysClient() == castOther.getSysClient()) || (this.getSysClient() == null ? false : (castOther.getSysClient() == null ? false : this.getSysClient().equals(castOther.getSysClient()))) && (this.getNarCurrency() == castOther.getNarCurrency()) || (this.getNarCurrency() == null ? false : (castOther.getNarCurrency() == null ? false : this.getNarCurrency().equals(castOther.getNarCurrency()))) && (this.getRefCurrencyRateType() == castOther.getRefCurrencyRateType()) || (this.getRefCurrencyRateType() == null ? false : (castOther.getRefCurrencyRateType() == null ? false : this.getRefCurrencyRateType().equals(castOther.getRefCurrencyRateType()))) && (this.getRefCurrencyRateAuthority() == castOther.getRefCurrencyRateAuthority()) || (this.getRefCurrencyRateAuthority() == null ? false : (castOther.getRefCurrencyRateAuthority() == null ? false : this.getRefCurrencyRateAuthority().equals(castOther.getRefCurrencyRateAuthority()))) && (this.getCurrencyPrec() == castOther.getCurrencyPrec()) || (this.getCurrencyPrec() == null ? false : (castOther.getCurrencyPrec() == null ? false : this.getCurrencyPrec().equals(castOther.getCurrencyPrec())));
    }
