...
public class SalaryHelper {
   ...
   *                        TripleSumSign.Plus - складываются только начисления, входящие со знаком
   *                        "плюс"; TripleSumSign.Minus - складываются только начисления, входящие
   *                        со знаком "минус". Результат > 0 !
   ...
   * @param positionFill         - исполненяемая должность. Если null, то для всех должностей,
   *                             исполняемых сотрудником
   ...
   * @return значение константы из справочника по коду и дате актуальности, или <code>null</code>
   * если не найдено
   */
   ...
   *
   * @param isByIncome   - признак отбора налогов: true - по указанному размеру дохода; false - по
   *                     номеру ставки
