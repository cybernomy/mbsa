...
public class FinOperProcessorImpl implements FinOperProcessor {
  ...
  /**
   * Устанавливает какие атрибуты можно копировать из образца фин. операции в создаваемую фин.
   * операцию
   *
   ...
   * @param listener - слушатель на событие открыть документ на редактирование
   */
   ...
   * @param finOper      - создаваемая фин. операция
   * @param finOperModel - образец создаваемой фин. операции
   * @param processDate  - время отработки ЭДО "Создать ФО"
   ...
   *
   * @param finOper - ФО
   * @param config  - конфигурация модуля фин. учет
   */
   ...
   *
   * @param finOper      - создаваемая ФО
   * @param finOperModel - образец ФО
   */
   ...
   *
   * @param srcDocHead   - документ-источник
   * @param finOper      - создаваемая фин. операция
   * @param finOperModel - образец фин. операции
   */
  ...
  /**
   * Осуществляется создание спецификаций создаваемой фин. операции, а также пересчет ее суммы с
   * учетом загружаемых алгоритмов
   *
   * @param finSpecModel - спецификация образца фин. операции
   * @param parentSpec   - для проводок признаков - идентификатор проводки счетов, которой
   *                     принадлежит данная проводка, а для проводок счетов - null
   */
   ...
   *
   * @param curTo              - в какую валюту
   * @param curFrom            - из какой валюты
   * @param curServ            - сервис конвертации валют
   * @param currencyFromAmount - значение которое хотим конвертить
   * @param config             - кофигурация модуля фин. учет
   ...
   * @param parent       - для проводок признаков - идентификатор проводки счетов, которой
   *                     принадлежит данная проводка, а для проводок счетов - null
