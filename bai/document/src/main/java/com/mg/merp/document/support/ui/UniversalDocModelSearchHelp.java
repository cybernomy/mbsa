...
/**
 * Универсальный поиск образцов документов всех типов, использует в качестве SearchHelp класс
 * установленный в атрибуте DocSection.DocumentModelSearchHelp. Содержит контекст импорта из
 * следующих параметров: {@link com.mg.merp.document.model.DocSection DocSection} - раздел
 * документа, {@link com.mg.merp.core.model.Folder DocModelFolder} - папка образца (если
 * <code>null</code> то поиск будет производиться без учета папки)
 *
