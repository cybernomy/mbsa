...
/**
 * Вспомогательный класс для отображения формы спецификации складских документов
 *
 * @author leonova
 * @author Artem V. Sharapov
 * @version $Id: WarehouseDocSpecMaintenanceEJBQLTableModel.java,v 1.4 2008/12/25 10:26:25 safonov
 *          Exp $
 */
public class WarehouseDocSpecMaintenanceEJBQLTableModel extends GoodsDocSpecMaintenanceEJBQLTableModel {
  ...
  /**
   * Признак добавления описателя поля "склад-источник" в список описателей полей, отображаемых в
   * таблице
   *
   * @return <code>true</code> - описатель поля "склад-источник" будет добавлен в список описателей
   * полей, отображаемых в таблице
   */
  ...
  /**
   * Признак добавления описателя поля "МОЛ склада-источника" в список описателей полей,
   * отображаемых в таблице
   *
   * @return <code>true</code> - описатель поля "МОЛ склада-источника" будет добавлен в список
   * описателей полей, отображаемых в таблице
   */
