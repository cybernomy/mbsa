...
/**
 * Бизнес-расширение "Пользовательская стратегия списания товарной позиции со склада". Класс
 * алгоритма должен реализовывать следующий метод <code>protected GoodsIssueStrategy
 * createGoodsIssueStrategy()</code>. Метод возвращает стратегию списания товарной позиции со
 * склада.
 *
