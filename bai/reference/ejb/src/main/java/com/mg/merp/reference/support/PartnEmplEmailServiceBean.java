 ...
 * @ejb.bean name = "PartnEmplEmailService" type = "Stateless" view-type = "local" local-jndi-name =
 * "merp/reference/PartnEmplEmailService" description = "PartnEmplEmail" display-name =
 * "PartnEmplEmail"
 ...
 * "com.mg.merp.reference.support.PartnEmplEmailDomainImpl"
