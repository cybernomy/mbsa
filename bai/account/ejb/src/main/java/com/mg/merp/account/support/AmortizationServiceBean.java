...
public class AmortizationServiceBean extends com.mg.framework.generic.AbstractPOJODataBusinessObjectServiceBean<Amortization, Integer> implements AmortizationServiceLocal {
   ...
   * @param from     - контрагент "От кого"
   * @param folder   - папка хоз. операции
   * @return - созданную хоз. операцию
   */
   ...
   * @param summaNat  - сумма устанавливаемая в проводке
   */
   ...
   *
   * @param inventory - данные по видам учета
   * @param sumTotal  - сумма
   * @param amortDate - дата начисление амортизации
   */
   ...
   *
   * @param inventory    - данные по видам учета
   * @param amortization - ведомость начисления амортизации
   * @param eo           - хоз. операция
   * @param es           - проводка хоз. операции
   * @param deprVal      - изменение остаточной стоимости, при переоценке - изменение начисленной
   *                     амортизации
  ...
  /**
   * По месяцу начисления амортизации в абсолютном исчислении возвращает дату начисления
   * амортизации
   *
   * @param months - месяц начисления амортизации в абсолютном исчислении (год*12 + месяц)
   * @return - дату начисления амортизации
   */
