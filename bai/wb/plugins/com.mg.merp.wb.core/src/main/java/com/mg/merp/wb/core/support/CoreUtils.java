...
public class CoreUtils {
  ...
  /**
   * Сохранение строкового массива в конфигурационном файле плагина. Работает только у графических
   * плагинов
   *
   * @param plugin плагин
   * @param key    ключ сохраняемого параметра
   * @param arr    сохраняемый массив
   */
  ...
  /**
   * Загрузка строкового массива из конфигурационного файла плагина. Работает только у графических
   * плагинов
   *
   * @param plugin плагин
   * @param key    ключ загружаемого параметра
   * @return массив строк
   */
   ...
   * @param plugin плагин
   * @param key    ключ сохраняемого параметра
   * @param value  сохраняемое целое число
   */
  ...
  /**
   * Преобразование строкового массива в строку. Может использоваться для хранения строковых
   * массивов в конфигурации НЕ графического плагина.
   *
   * @param arr   входной массив строк
   * @param delim символ разделителя
   * @return строка, созданная из массива
   */
  ...
  /**
   * Преобразование списка строк в строку. Может использоваться для хранения строковых массивов в
   * конфигурации НЕ графического плагина.
   *
   * @param list  список строк
   * @param delim символ разделителя
   * @return строка, созданная из списка
   */
   ...
   * @param e   исключительна ситуация
   */
