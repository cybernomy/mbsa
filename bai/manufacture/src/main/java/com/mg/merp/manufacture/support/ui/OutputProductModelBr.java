 ...
 * @version $Id: OutputProductModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class OutputProductModelBr extends ManufactureModelBrowseForm {

  public OutputProductModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", OutputProductModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(OutputProductModelServiceLocal.FOLDER_PART);
  }
