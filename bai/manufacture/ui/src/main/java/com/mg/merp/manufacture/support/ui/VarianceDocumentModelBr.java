 ...
 * @version $Id: VarianceDocumentModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class VarianceDocumentModelBr extends ManufactureModelBrowseForm {

  public VarianceDocumentModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", VarianceDocumentModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(VarianceDocumentModelServiceLocal.FOLDER_PART);
  }
