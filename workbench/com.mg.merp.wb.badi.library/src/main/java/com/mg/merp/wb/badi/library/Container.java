...
public class Container implements IClasspathContainer {
  ...
  /**
   * Метод заполняет контейнер jar библиотеками в соответствии с {@link Container#includedLibs} и
   * включает библиотеки из папки thirdpart
   */
  ...
  /**
   * Метод создаёт Set строк, из конфигурации Java-проекта, и представляет список имён архивов,
   * доступных для помещения в библиотеку
   */
