...
public class DeployerPlugin extends BusinessObjectPlugin<RptMainTransfer> {
	 ...
	 * @param rmt
	 *            отчёт
	 * @return изменённый отчёт, с новой временной меткой, пустой отчёт в случае
	 *         изменеия отчёта в базе третьей стороной и NULL, если отчёт с
	 *         таким же кодом и идентификатором отсутствует
	 * @throws Exception
	 */
