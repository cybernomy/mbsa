...
public class ColumnMappingPage extends WizardPage implements IPropertyPage,
  ...
  /**
   * when the page activated, the information about column will retrieved from the datasetHandle
   */
  ...
  /**
   * Depending on the column mapping, the properties of various controls on this page are set
   */
