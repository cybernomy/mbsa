...
/**
 * Базовый класс для плагинов с поддержкой локализованных сообщений и вызовом удалённых методов на
 * сервере приложений.
 *
...
public class MerpUIPlugin extends AbstractUIPlugin {
   ...
   *
   * @param name   имя сервиса, у которого вызывается метод
   * @param method имя вызываемого метода
   * @param args   значения аргументов, передаваемых в метод
   * @param sig    сигнатура метода
   * @return результат вызова операции
   */
