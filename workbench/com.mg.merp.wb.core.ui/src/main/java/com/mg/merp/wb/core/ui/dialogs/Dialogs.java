...
public class Dialogs {
   ...
   * @param flags   флаги (ОК, CANCEL...)
   * @return код выбранной кнопки диалога
   */
   ...
   * @param message  текст сообщения
   * @param pluginId идентификатор плагин, из которого вызывается диалог
   * @param ex       исключительная ситуация
   * @return код выбранной кнопки диалога
   */
