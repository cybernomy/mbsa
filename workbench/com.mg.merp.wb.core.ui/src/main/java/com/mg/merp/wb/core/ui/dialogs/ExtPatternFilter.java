...
/**
 * Фильтр, используемый в объектах типа FilteredTree. Есть возможность отмечать объекты как
 * соответствующие фильтру принудительно, т.е. даже если они не подходят по маске
 *
...
public class ExtPatternFilter extends PatternFilter {
  ...
  /**
   * Добавление объекта в список "подходящих". Объект с именем matchStr будет выделен всегда,
   * независимо от соответствия фильтру
   *
   * @param matchStr принудительно добавляемый объект
   */
