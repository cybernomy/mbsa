 ...
 * 
 * V - Класс управляемого вида.<br>
 * I - Класс объектов наполнения таблицы
 * 
...
public abstract class StandartBrowserViewController<V extends StandartBrowserView, I>
	...
	/**
	 * флаг наличия синхронизации панели и сервера приложений. Если
	 * синхронизация отсутствует, то никакие действия не доступны с объектами
	 */
