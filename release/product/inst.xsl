    ...
    <installation version="1.0">
      ...
      <packs>
        <pack name="AppServer" id="appserver.package" required="no">
          ...
          <!-- JBoss -->
          <file src="./common/output/appserver/bin" targetdir="$INSTALL_PATH/appserver"
                override="true"/>
          <file src="./common/output/appserver/client" targetdir="$INSTALL_PATH/appserver"
                override="true"/>
          <file src="./common/output/appserver/docs" targetdir="$INSTALL_PATH/appserver"
                override="true"/>
          <file src="./common/output/appserver/lib" targetdir="$INSTALL_PATH/appserver"
                override="true"/>
          <fileset dir="./common/output/appserver/server"
                   targetdir="$INSTALL_PATH/appserver/server"
                   excludes="**/merp-ds.xml"
                   override="true"/>
          <file src="./common/output/appserver/server/merp/deploy/merp-ds.xml"
                targetdir="$INSTALL_PATH/appserver/server/merp/deploy"
                override="false"/>

          <file src="./common/output/version"
                targetdir="$INSTALL_PATH/appserver/server/merp/mg-custom" override="true"/>
          ...
          <fileset dir="./common/conf"
                   targetdir="$INSTALL_PATH/appserver/server/merp/mg-custom/conf"
                   override="true"/>
          <fileset dir="./common/patches"
                   targetdir="$INSTALL_PATH/appserver/server/merp/mg-custom/patches"
                   override="true"/>
          <fileset dir="./common/languages"
                   targetdir="$INSTALL_PATH/appserver/server/merp/mg-custom/languages"
                   override="true"/>
        ...
        <pack name="AppServConsole" id="console.package" required="no">
          ...
          <file src="./common/output/appserver/client/jbossall-client.jar"
                targetdir="$INSTALL_PATH/tools/lib"/>
          <file src="./common/output/appserver/client/log4j.jar"
                targetdir="$INSTALL_PATH/tools/lib"/>
          <file src="./common/output/appserver/client/getopt.jar"
                targetdir="$INSTALL_PATH/tools/lib"/>
          ...
          <file src="./linux/startconsole.sh" targetdir="$INSTALL_PATH/tools/console"
                os="unix"/>
          <executable targetfile="$INSTALL_PATH/tools/console/startconsole.sh" stage="never"
                      os="unix"/>
        ...
        <pack name="Database" id="db.package" required="no">
          ...
          <file src="./common/db/MERP4.FDB"
                targetdir="$INSTALL_PATH/appserver/server/merp/data/firebird"/>
          <file src="./common/db/MERP4.FBK"
                targetdir="$INSTALL_PATH/appserver/server/merp/data/firebird"/>
        </pack>
