...
<!-- $Id: docprocess.hs,v 1.1 2007/06/09 12:48:09 konyashkina Exp $ -->
...
<helpset version="1.0">
  ...
  <view>
    ...
    <title>Настройка документооборота. Типы документов. Параметры этапов</title>
    <data engine="oracle.help.engine.XMLIndexEngine">index.xml</data>
  </view>

  <view>
    <label>Поиск</label>
    <title>Настройка документооборота</title>
