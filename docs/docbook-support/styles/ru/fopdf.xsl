...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format"
                version="1.0"
                xmlns="http://www.w3.org/TR/xhtml1/transitional" exclude-result-prefixes="#default">
          ...
          <fo:table-row>
            <fo:table-cell text-align="center">
              ...
              <xsl:if test="bookinfo/title">
                <fo:block font-family="sans-serif" font-size="22pt" padding-before="10mm">
                  <xsl:value-of select="bookinfo/title"/>
                </fo:block>
              </xsl:if>
              <xsl:if test="bookinfo/subtitle">
                <fo:block font-family="sans-serif" font-size="18pt" padding-before="10mm">
  ...
  <xsl:param name="formal.title.placement">figure before example before
