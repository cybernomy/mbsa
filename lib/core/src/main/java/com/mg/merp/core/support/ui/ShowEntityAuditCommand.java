 ...
 */
public class ShowEntityAuditCommand implements MenuCommand {

	/* (non-Javadoc)
	 * @see com.mg.framework.api.ui.MenuCommand#execute()
	 */
	public void execute() throws Exception {
		((EntityAuditForm) ApplicationDictionaryLocator.locate().getWindow("com.mg.merp.core.EntityAuditForm")).execute();
	}
	...
	public boolean isPermitted() {
		return SecurityUtils.tryCheckPermission(new BusinessMethodPermission(DatabaseAuditServiceLocal.SERVICE_NAME, BusinessMethodPermission.BROWSE_METHOD));
	}
