...
public interface DataItemDocumentation {
    public enum Status {
    	...
    	/**
    	 * Объект не используется в пользовательском интерфейсе, документация
    	 * не создана и не требуется
    	 */
    	NOT_USED_IN_SCREEN,
    	
    	/**
    	 * Краткий текст в достаточной степени описывает объект, документация
    	 * не создана и не требуется
    	 */
    	EXPLAINED_BY_SHORT,
    	
    	/**
    	 * Может быть использовано для описания элемента данных которые не полностью
    	 * реализованы, документация не существует
    	 */
    	POSTPONED
    }
