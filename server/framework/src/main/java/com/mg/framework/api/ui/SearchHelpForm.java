...
public interface SearchHelpForm extends Form {
	...
	/**
	 * установить сущность для позиционирования, например может использоваться механизмом
	 * поиска сущностей для передачи уже установленного значения в форму поиска для
	 * правильного позиционирования в UI
	 * 
