...
/**
 * –еализаци€ менеджера перманентного хранилища на базе Hibernate
 * 
...
public class PersistentManagerHibernateImpl implements PersistentManager, Serializable {
	...
	public void refresh(PersistentObject entity) {
		try {
			//FIXME не провер€ем присутствие в сессии, иногда необходимо обновл€ть detach объекты, однако это не рекомендуетс€ авторами Hibernate, что делать не совсем пон€тно
//			Session s = getCurrentSession();
...
//				throw new IllegalArgumentException("Entity not managed");
	 ...
	 * 
	 * @return	текуща€ сесси€
	 * @throws	IllegalStateException если текуща€ сесси€ не установлена
	 */
