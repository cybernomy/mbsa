...
/**
 * —тандартна€ форма дл€ отображени€ списков бизнес-компонетов
 * 
...
public class DefaultPlainBrowseForm extends AbstractSearchForm implements MaintenanceBrowseForm, MasterModelListener {
	...
	/**
	 * возвращает текст запроса дл€ получени€ выборки данного браузера
	 * 
	 * @return
	 */
	...
	/**
	 * создание модели таблицы дл€ браузера, необходимо переопредел€ть в классе наследнике
	 * 
	...
	/**
	 * получить слушатель событий от настраиваемых действий пользовател€
	 * 
	 * @return
	 */
	...
	public void run(boolean modal) {
		...
		//запускаем форму браузера, переопредел€ем run т.к. нельз€ прерывать стек вызовов метода doOnRun
		modalFlag = modal;
	...
	/**
	 * обработчик запуска настраиваемых действий пользовател€
	 * 
	 * @param event	событие
	 */
	...
	/**
	 * обработчик копировани€ сущности
	 * 
	 * @param event
	 */
	...
	/**
	 * обработчик копировани€ сущности с детал€ми
	 * 
	 * @param event
	 */
	...
	/**
	 * обработчик обновлени€ браузера сущностей
	 * 
	 * @param event
	 */
