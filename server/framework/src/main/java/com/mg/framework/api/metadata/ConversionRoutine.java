...
/**
 *  онвертаци€ значений атрибутов дл€ пользовательского интерфейса
 * 
...
public interface ConversionRoutine<S, U> {
	...
	/**
     * конвертаци€ из значени€ пользовательского интерфейса в значение
	...
	/**
     * конвертаци€ из значени€ обрабатываемого системой в значение
     * дл€ пользовательского интерфейса
	 * 
	 ...
	 * 
	 * @return	список наименование атрибутов дл€ импорта из модели
	 * 
	...
	/**
	 * устанавливает контекст импорта, значени€ импортируютс€ из модели контроллера
	 * формы текущей дл€ данного преобразовани€
	 * 
