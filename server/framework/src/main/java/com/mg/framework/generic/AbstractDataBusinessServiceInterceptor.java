...
/**
 * Ѕазовый абстрактный класс перехватчиков действий бизнес-компонентов управл€ющих данными,
 * рекомендуетс€ использовать при создании собственных перехватчиков
 * 
