...
/**
 * Ёлемент "ћенеджер расположени€ форм поддержки бизнес-компонентов"
 * 
...
public interface DefaultMtGridBagPane extends GridBagLayoutPane {
	...
	/**
	 * атрибут указывающий, что данное поле будет раст€нуто на всю длинну формы,
	 * имеет тип <code>boolean</code>
	 */
	final static String LONG_FIELD = "longField";
	
	/**
	 * атрибут группы полей, все пол€ начина€ с текущего будут отделены от предыдущих полей,
