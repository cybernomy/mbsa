...
public interface Filler extends Widget {
	...
	/**
	 * атрибут тип заполнителя, может иметь следующие значения
	 * </br>glue
	 * </br>horizontalGlue
	 * </br>verticalGlue
	 * </br>verticalStrut
	...
	/**
	 * распорка по горизонтали и вертикали, размер распорки устанавливается через атрибуты {@link #HEIGHT} и
	 * {@link #WIDTH}
	 */
