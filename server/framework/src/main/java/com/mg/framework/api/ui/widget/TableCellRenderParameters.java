...
/**
 * ѕараметры отрисовки €чейки таблицы
 * 
...
public interface TableCellRenderParameters {
	...
	/**
	 * установить признак отображени€ текста
	 * 
	 * @param textVisible	если <code>true</code> то текст отображаетс€
	 */
	...
	/**
	 * установить иконку дл€ отображени€
	 * 
	 * @param icon	иконка
	 */
