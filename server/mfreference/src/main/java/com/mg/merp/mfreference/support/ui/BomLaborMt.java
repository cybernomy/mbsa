 ...
 * @version $Id: BomLaborMt.java,v 1.5 2007/07/30 10:24:19 safonov Exp $
 */
public class BomLaborMt extends DefaultMaintenanceForm implements MasterModelListener {
  protected AttributeMap costDetailLineProperties = new LocalDataTransferObject();
  private DefaultTableController costDetailLine;

  public BomLaborMt() throws Exception {
