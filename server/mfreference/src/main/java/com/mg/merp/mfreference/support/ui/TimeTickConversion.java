...
/**
 * Конвертация тиков производства в установленные ЕИ, используется как базовый класс
 * для конвертации различных атрибутов
 * 
...
public abstract class TimeTickConversion extends AbstractConversionRoutine<Long, BigDecimal> {
	...
	/**
	 * получение ЕИ для времени, необходимо переопределить в классе наследнике
	 * для получения реальной ЕИ времени
	 * 
	 * @return
	 */
