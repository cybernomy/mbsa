...
/**
 * ”тилиты дл€ модулей производство
 * 
...
public class MfUtils {
	...
	/**
	 * преобразование тиков во врем€ выраженное в ≈»
	 * 
	 * @param tick		тики
	 * @param timeUM	≈» времени
	 * @return			врем€
	 */
	...
	/**
	 * преобразование времени выраженного в ≈» в тики производства
	 * 
	 * @param tick		врем€
	 * @param timeUM	≈» времени
	 * @return			тики
	...
	/**
	 * преобразование времени в тиках производства в врем€
	 * 
	 * @param tick	врем€ в тиках
	 * @return	врем€
	 */
	 ...
	 * 
	 * @param quantityRateFlag	тип вычислени€ количества
	 * @param quan				количество
	 * @param timeOper			врем€ операции
	 ...
	 * @param baseDateTime		врем€
	 * @param runTime			врем€ работы
	 * @param schedDirection	направление планировани€
	 * @return	диапазон
	 */
	...
	/**
	 * вычисление количество материала дл€ состава издели€
	 * 
	 * @param bomMaterial	материал в составе издели€
	...
	/**
	 * —оздает строку расшифровки стоимости
	 * 
	 * @param costDetail
	 * @param costCategory
	 * @param cost
	...
	/**
	 * определение смещени€ бакета
	 * 
	 * @param planningLevelId	уровень планировани€
	...
	/**
	 * настройка дат действий объектов производства, производитс€ поиск полей с именами EffOffDate и EffOnDate,
	 * если данные пол€ не установлены, то привод€тс€ к стандартным значени€м
	 * 
