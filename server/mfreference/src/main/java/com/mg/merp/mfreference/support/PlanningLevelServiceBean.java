...
/**
 * –еализаци€ бизнес-компонента "”ровни планировани€" 
 * 
 * @author leonova
...
public class PlanningLevelServiceBean extends AbstractPOJODataBusinessObjectServiceBean<PlanningLevel, Integer> implements PlanningLevelServiceLocal {
	...
	/**
	 * —оздать периоды уровн€ планировани€
	 * @param planningLevel - уровень планировани€
	 * @param bucketLength - длина периода в дн€х
	...
	/**
	 * ѕолучить последний "бакет" уровн€ планировани€
	 * @param planningLevel - уровень планировани€
	 * @return "бакет" с максимальным пор€дковым номером
	 */
	...
	/**
	 * »нициализировать "бакет"
	 * @param planningLevel  - уровень планировани€
	 * @param startDate - начальна€ дата "бакета"
	 * @param endDate - конечна€ дата "бакета"
	 * @param bucketOffset - пор€дковый номер "бакета"
	...
	/**
	 * ѕоместить "бакет" в перманентное хранилище
