...
/**
 * Ѕизнес-компонент "—пецификации документа"
 * 
...
public interface GoodsDocumentSpecification<T extends com.mg.merp.document.model.DocSpec, ID extends Serializable>
	 ...
	 * @param goodsInfoList	список номенклатуры дл€ создани€ спецификаций
	 */
	void bulkCreate(DocHead docHead, CreateSpecificationInfo[] goodsInfoList);
	
	/**
	 * расчет атрибутов позиции спецификации, при использовании штатных методов создани€ и изменени€
	 * вызов данного метода не требуетс€, если атрибут {@link com.mg.merp.document.model.DocSpec#isAdjusted() Adjusted}
	...
	/**
	 * –асчет срока годности у позиций спецификации документа
	 * 
