...
public interface GoodsDocument<T extends DocHead, ID extends Serializable, M extends DocumentPattern, S extends GoodsDocumentSpecification> extends Document<T, ID, M> {
  ...
  /**
   * изменение спецификаций документа, необходимо вызвать для изменения заголовка документа после
   * изменения спецификаций, в случае использования штатных сервисов системы вызов не требуется
   *
  ...
  /**
   * создание спецификаций документа, необходимо вызвать для изменения заголовка документа после
   * добавления спецификаций, в случае использования штатных сервисов системы вызов не требуется.
  ...
  /**
   * удаление спецификаций документа, необходимо вызвать для изменения заголовка документа после
   * удаления спецификаций, в случае использования штатных сервисов системы вызов не требуется
   *
   * @param docSpec спецификации
   */
