...
/**
 * Вспомогательная информация, необходимая для построения ресультирующего набора данных запроса
 *
 * @author Valentin A. Poroxnenko
 * @version $Id: RelationInformation.java,v 1.4 2006/11/07 08:04:27 poroxnenko Exp $
 */
public class RelationInformation {
   ...
   * Конструктор
   *
   * @param relationString строка, содержащая метаданные, необходимые для построения таблицы
   */
