...
public class ManualDistributionDlg extends AbstractForm {
      ...
      public Object getValueAt(int row, int column) {
        ...
        switch (column) {
          case 0:
            return item.id;
          case 1:
            return String.format("%1$td.%1tm.%1$tY", item.beginActionDate); //$NON-NLS-1$
          case 2:
            return String.format("%1$td.%1tm.%1$tY", item.endActionDate); //$NON-NLS-1$
          case 3:
            return item.contractorFrom;
          case 4:
            return item.contractorTo;
          case 5:
            return item.planSum;
          case 6:
            return item.factSum;
  ...
  /**
   * Получить количество распределенных позиций (т.е. те позиции у которых распределенная сумма >
   * 0)
   *
   * @return количество
   */
