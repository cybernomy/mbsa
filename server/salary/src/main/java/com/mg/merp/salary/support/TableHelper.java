...
public class TableHelper {
  ...
  /**
   * Получить количество дней/часов за указанный период, для которых в табеле есть запись с
   * указанным типом времени
   *
   ...
   * @param beginDate    - дата начала периода
   * @param endDate      - дата окончания периода
   * @return количество дней/часов за указанный период, для которых в табеле есть запись с указанным
   * типом времени
   */
