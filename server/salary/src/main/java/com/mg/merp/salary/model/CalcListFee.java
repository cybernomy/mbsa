...
/**
 * ћодель бизнес-компонента "Ќачислени€/ударжани€ расчетных листков"
 * 
...
public class CalcListFee extends com.mg.framework.service.PersistentObjectHibernate implements java.io.Serializable {
	...
	/**
	 * ѕолучить список параметров начислени€/удержани€ расчетного листка
	 * @return список параметров начислени€/удержани€ расчетного листка
	 */
