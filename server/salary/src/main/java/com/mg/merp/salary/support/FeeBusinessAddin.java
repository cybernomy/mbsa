 ...
 *
 * <p>Класс расширения должен реализовывать следующий метод: <code>protected void doPerform() throws
 * Exception</code>. <p>Метод возвращает результат выполнения расчета начислений/удержаний ЗП.
 *
