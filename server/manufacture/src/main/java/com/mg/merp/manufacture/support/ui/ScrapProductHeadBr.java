 ...
 */
public class ScrapProductHeadBr extends ScrapDocumentBr {
  private final String INIT_QUERY_TEXT = "select %s from ScrapDocumentHead d %s %s";

  public ScrapProductHeadBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", ScrapProductHeadServiceLocal.FOLDER_PART);
    restrictionFormName = "com/mg/merp/manufacture/resources/ScrapProductHeadRest.mfd.xml";
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return CoreUtils.loadFolderHierarchy(ScrapProductHeadServiceLocal.FOLDER_PART);
  }
