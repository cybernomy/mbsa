 ...
 */
public class InputMaterialHeadBr extends InputDocumentBr {	
	private final String INIT_QUERY_TEXT = "select %s from InputDocumentHead d %s %s";
	
	public InputMaterialHeadBr() throws Exception {
		super();
		folderService =  (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
		treeUIProperties.put("FolderType", InputMaterialHeadServiceLocal.FOLDER_PART);
		restrictionFormName = "com/mg/merp/manufacture/resources/InputMaterialHeadRest.mfd.xml";
	}
	...
	protected TreeNode loadFolders() throws ApplicationException {
		return CoreUtils.loadFolderHierarchy(InputMaterialHeadServiceLocal.FOLDER_PART);
	}
