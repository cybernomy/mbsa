 ...
 */
public class ScrapMachineHeadBr extends ScrapDocumentBr {
	private final String INIT_QUERY_TEXT = "select %s from ScrapDocumentHead d %s %s";
	
	public ScrapMachineHeadBr() throws Exception {
		super();
		folderService =  (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
		treeUIProperties.put("FolderType", ScrapMachineHeadServiceLocal.FOLDER_PART);
		restrictionFormName = "com/mg/merp/manufacture/resources/ScrapMachineHeadRest.mfd.xml";
	}	
	...
	protected TreeNode loadFolders() throws ApplicationException {
		return CoreUtils.loadFolderHierarchy(ScrapMachineHeadServiceLocal.FOLDER_PART);
	}
