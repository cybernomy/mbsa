 ...
 * @version $Id: InputMaterialModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class InputMaterialModelBr extends ManufactureModelBrowseForm {

  public InputMaterialModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", InputMaterialModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(InputMaterialModelServiceLocal.FOLDER_PART);
  }
