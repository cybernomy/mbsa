/*
 * JobRouteSchedTickConversion.java
 *
...
/**
 * Конвертация атрибута SchedTime объекта JobRoute
 * 
 * @author Oleg V. Safonov
 * @version $Id: JobRouteSchedTickConversion.java,v 1.1 2006/07/07 10:11:14 leonova Exp $
 */
public class JobRouteSchedTickConversion extends TimeTickConversion {
