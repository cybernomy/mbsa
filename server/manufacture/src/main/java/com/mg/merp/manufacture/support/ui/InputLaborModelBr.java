 ...
 * @version $Id: InputLaborModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class InputLaborModelBr extends ManufactureModelBrowseForm {

  public InputLaborModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", InputLaborModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(InputLaborModelServiceLocal.FOLDER_PART);
  }
