 ...
 * @version $Id: InputMachineModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class InputMachineModelBr extends ManufactureModelBrowseForm {

  public InputMachineModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", InputMachineModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(InputMachineModelServiceLocal.FOLDER_PART);
  }
