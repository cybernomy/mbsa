 ...
 * @version $Id: ScrapLaborModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class ScrapLaborModelBr extends ManufactureModelBrowseForm {

  public ScrapLaborModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", ScrapLaborModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(ScrapLaborModelServiceLocal.FOLDER_PART);
  }
