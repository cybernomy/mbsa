 ...
 * @version $Id: ScrapProductModelBr.java,v 1.4 2006/09/12 11:08:35 leonova Exp $
 */
public class ScrapProductModelBr extends ManufactureModelBrowseForm {

  public ScrapProductModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", ScrapProductModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(ScrapProductModelServiceLocal.FOLDER_PART);
  }
