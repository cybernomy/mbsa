/*
 * JobRouteQueueTickConversion.java
 *
...
/**
 * Конвертация атрибута QueueTime объекта JobRoute
 *
 * @author Oleg V. Safonov
 * @version $Id: JobRouteQueueTickConversion.java,v 1.1 2006/07/07 10:11:14 leonova Exp $
 */
public class JobRouteQueueTickConversion extends TimeTickConversion {
