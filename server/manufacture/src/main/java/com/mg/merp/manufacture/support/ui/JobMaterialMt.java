 ...
 * @version $Id: JobMaterialMt.java,v 1.5 2007/07/30 10:27:10 safonov Exp $
 */
public class JobMaterialMt extends DefaultMaintenanceForm implements MasterModelListener {
  ...
  public JobMaterialMt() throws Exception {
