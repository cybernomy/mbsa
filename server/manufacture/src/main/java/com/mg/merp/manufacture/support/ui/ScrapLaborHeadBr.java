 ...
 */
public class ScrapLaborHeadBr extends ScrapDocumentBr {
	private final String INIT_QUERY_TEXT = "select %s from ScrapDocumentHead d %s %s";
	
	public ScrapLaborHeadBr() throws Exception {
		super();
		folderService =  (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
		treeUIProperties.put("FolderType", ScrapLaborHeadServiceLocal.FOLDER_PART);
		restrictionFormName = "com/mg/merp/manufacture/resources/ScrapLaborHeadRest.mfd.xml";
	}
	...
	protected TreeNode loadFolders() throws ApplicationException {
		return CoreUtils.loadFolderHierarchy(ScrapLaborHeadServiceLocal.FOLDER_PART);
	}
