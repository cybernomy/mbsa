 ...
 * @version $Id: DefaultRtlDocSpecPropertiesCalculationStrategyTest.java,v 1.1 2007/10/30 14:59:08
 *          sharapov Exp $
 */
public class DefaultRtlDocSpecPropertiesCalculationStrategyTest {
   ...
   *
   * Входные параметры: кол-во цена скидка/наценка
   */
  @Test
   ...
   * Расчет цены
   *
   * Входные параметры: кол-во цена со скидкой/наценкой
   */
  @Test
