...
<!-- $Id: merpclientsb.jsp,v 1.3 2009/02/09 15:53:26 safonov Exp $ -->
...
<jsp:plugin
	...
	codebase="."
	archive="lib/merp-applet-client.jar,lib/ulc-all5-client.jar,lib/merp-ulccomponent-client.jar,lib/jgraph.jar,lib/substance-lite-feel.jar"
	height="100%"
	width="100%"
	jreversion="1.6">
	<jsp:params>
        ...
        <jsp:param name="look-and-feel" value="org.jvnet.substance.skin.SubstanceBusinessBlackSteelLookAndFeel" />
	</jsp:params>

	<jsp:fallback>Your browser does not support JDK 6.0 or higher for applets.</jsp:fallback>
</jsp:plugin>
...
<APPLET WIDTH = "100%" HEIGHT = "100%"
    ...
    <PARAM NAME = "look-and-feel" VALUE = "org.jvnet.substance.skin.SubstanceBusinessBlackSteelLookAndFeel">
    Your browser does not support JDK 6.0 or higher for applets.
</APPLET>
