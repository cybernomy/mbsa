...
/**
 * @ejb.bean name = "SysModuleService"
 *           type = "Stateless"
 *           view-type = "local"
 *           local-jndi-name = "merp/reference/SysModuleService"
 *           description = "SysModule"
 *           display-name = "SysModule"
 *
 ...
 *                value = "com.mg.merp.reference.support.SysModuleDomainImpl"
 *
