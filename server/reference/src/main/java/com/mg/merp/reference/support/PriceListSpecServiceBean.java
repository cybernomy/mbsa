...
public class PriceListSpecServiceBean extends AbstractPOJODataBusinessObjectServiceBean<PriceListSpec, Integer> implements PriceListSpecServiceLocal {
  ...
  /**
   * Получить аналогичные позиции спецификации (т.е те у которых совпадают заголовок Прайс-листа и
   * позиция Каталога)
   *
   * @param entity - позиция спецификации
   ...
   *
   * @param priceListHeadId - идентификатор заголовока прайс-листа
   * @param priceListFolder - папка прайс-листа
   * @param catalogs        - список каталожных позиций
   */
