...
public class AttachmentHelper {
	...
	/**
	 * интеркативное сохранение вложений в системе, происходит запрос файла для сохранения,
	 ...
	 * 
	 * @param keys - список первичных ключей сущностей
	 * @param attachmentServiceName - имя бизнес-сервиса, поддерживающего основную функциональность работы с вложениями
	 */
	 ...
	 * 
	 * @param keys - список первичных ключей сущностей
	 * @param attachmentService - cервис бизнес-компонента, поддерживающий основную функциональность работы с вложениями
	 */
