...
public class PriceListFolderServiceBean extends AbstractPOJODataBusinessObjectServiceBean<PriceListFolder, Integer> implements PriceListFolderServiceLocal {
   ...
   * @param priceListFolderParent - папка родитель для создаваемой папки
   * @param catalogFolder         - папка КТУ по которой создается папка прайс-листа
   * @return - созданную папку прайс-листа
   */
