 ...
 * @ejb.bean name = "SysPartService" type = "Stateless" view-type = "local" local-jndi-name =
 * "merp/reference/SysPartService" description = "SysPart" display-name = "SysPart"
 ...
 * "com.mg.merp.reference.support.SysPartDomainImpl"
