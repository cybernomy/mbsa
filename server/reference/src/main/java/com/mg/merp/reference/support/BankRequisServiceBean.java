...
/**
 * @ejb.bean name = "BankRequisService"
 *           type = "Stateless"
 *           view-type = "local"
 *           local-jndi-name = "merp/reference/BankRequisService"
 *           description = "BankRequis"
 *           display-name = "BankRequis"
 *
 ...
 *                value = "com.mg.merp.reference.support.BankRequisDomainImpl"
 *
