...
/**
 * @author leonova
 * @version $Id: InventoryForecastSearchHelp.java,v 1.2 2006/07/10 12:02:15 leonova Exp $
 */
public class InventoryForecastSearchHelp extends DefaultLegacySearchHelp {
	...
	protected String getServiceName() {
		return "merp/planning/InventoryForecast";
	}
