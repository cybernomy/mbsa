...
/**
 *  онтроллер формы поддержки бизнес-компонента "«начение константы"
 * 
...
public class ConstantValueMt extends DefaultMaintenanceForm{
	...
	protected FieldMetadata doGetFieldMetadata(String name) {
		...
		//переопредел€ем метаданные в зависимости от типа константы дл€ user friendly отображени€ значени€ константы
		if (VAL_ATRIBUTE_NAME.equals(name)) { //$NON-NLS-1$
			...
			//”станавливаем количество знаков после зап€той дл€ типа константы FLOAT
