...
/**
 * –еализаци€ процессора модул€ "–асчеты с партнерами"
 * 
...
public class SettlementProcessorServiceBean extends AbstractPOJOBusinessObjectStatefulServiceBean implements SettlementProcessorServiceLocal {
	...
	/**
	 * ќбновить карточку расчетов с партнером
	 * @param isPlan 
	 * @param isSet - признак "поставить в план" / "сн€ть с плана"
	 ...
	 * @return результат завершени€ операции
	 */
	...
	/**
	 * ѕолучить карточку расчетов с партнером
	...
	/**
	 * —оздать карточку расчетов с партнером
	 * @param company - подразделение
	 * @param partner - партнер
	 * @return карточка расчетов с партнером
	 */
	...
	/**
	 * ќбновить параметры документооборота 
	 */
