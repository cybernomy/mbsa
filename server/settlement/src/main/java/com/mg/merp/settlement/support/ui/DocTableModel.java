...
public class DocTableModel extends AbstractTableModel {
	...
	public Object getValueAt(int row, int column) {
		...
		switch (column) {
		case 0: return item.docType;
		case 1: return item.docNumber;
		case 2: return String.format(DATE_FORMAT, item.docDate);
		case 3: return item.curCode;
		case 4: return item.sumNat == null ? new BigDecimal(0) : item.sumNat;
		case 5: return item.sumCur == null ? new BigDecimal(0) : item.sumCur;
		}
		return null;
	}
