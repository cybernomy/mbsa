...
public class FacturaHeadModelInBr extends DocumentModelBrowseForm {
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(FacturaHeadModelInServiceLocal.FOLDER_PART);
  }
