...
/**
 * –еализаци€ процессора счетов-фактур
 * 
...
public class FacturaProcessorServiceBean extends AbstractPOJOBusinessObjectStatefulServiceBean implements FacturaProcessorServiceLocal {
	...
	/**
	 * –егистраци€ счета-фактуры в книге покупок
	 * @param docHead - счет-фактура
	 * @param docSpec - позици€ документа
	...
	/**
	 * ¬ыполнить округление сумм книги покупок
	 * @param book - книга покупок
	 * @param roundPrec - точность округлени€
	 */
	...
	/**
	 * ¬ыполнить округление сумм книги продаж
	...
	/**
	 * ѕолучить данные о налогах дл€ позиции документа
	 * @param docSpec - позици€ документа
	...
	/**
	 * Ёлемент данных о налогах позиции документа
	 */
