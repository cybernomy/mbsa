 ...
 */
public class FacturaHeadInMt extends GoodsDocumentMaintenanceForm implements MasterModelListener {

  public FacturaHeadInMt() throws Exception {
    super();
    contractorFromKinds = new String[]{ContractorSearchForm.CONTRACTOR_PARTNER};
    specService = ((FacturaSpecInServiceLocal) ApplicationDictionaryLocator.locate().getBusinessService("merp/factura/FacturaSpecIn"));
