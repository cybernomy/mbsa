...
/**
 *  онтроллер браузера бизнес-компонента "ќстатки и обороты по признакам"
 * 
 * @author leonova
	...
	protected MaintenanceTableModel createModel() {
		return new DefaultMaintenanceEJBQLTableModel() {
			...
			public FieldMetadata getColumnMetadata(int column) {
				//дл€ полей аналитик встроенные метаданные представл€ют целые значени€,
				//но требуетс€ отображение строк
