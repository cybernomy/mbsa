...
public class ChooseDocumentSpecDialog extends DefaultWizardDialog {
	...
	private class DocSpecListModel extends AbstractTableModel {
		...
		public Object getValueAt(int row, int column) {
			...
			switch (column) {
			case 0: return item.getDocSpec().getCatalog().getCode();
			case 1: return item.getDocSpec().getCatalog().getFullName();
			case 2: return item.getDocSpec().getPrice();
			case 3: return item.getDocSpec().getSumma();
			case 4: return item.getFreeQuantity1();
			case 5: return item.getFreeQuantity2();
			case 6: return item.getPerformedSum();
			case 7: return item.getPerformedQuantity1();
			case 8: return item.getPerformedQuantity2();
			default: return null;
			}
		}
		...
		public FieldMetadata getColumnMetadata(int column) {
			switch (column) {
			case 2: return applicationDictionary.getFieldMetadata(DocSpec.class, "Price");
			case 3: return applicationDictionary.getFieldMetadata(DocSpec.class, "Summa");
			case 4: return applicationDictionary.getFieldMetadata(DocSpec.class, "Quantity");
			case 5: return applicationDictionary.getFieldMetadata(DocSpec.class, "Quantity2");
			case 6: return applicationDictionary.getFieldMetadata(DocSpec.class, "Summa");
			case 7: return applicationDictionary.getFieldMetadata(DocSpec.class, "Quantity");
			case 8: return applicationDictionary.getFieldMetadata(DocSpec.class, "Quantity2");
			default: return super.getColumnMetadata(column);
			}
		}
