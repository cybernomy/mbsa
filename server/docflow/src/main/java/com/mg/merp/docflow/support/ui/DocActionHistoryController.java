...
public class DocActionHistoryController extends AbstractTableModel {
	...
	public Object getValueAt(int row, int column) {
		...
		switch (column) {
		case 0: return item.getReadySum();
		case 1: return DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.MEDIUM, ServerUtils.getUserLocale()).format(item.getDateTime());
		case 2: return item.getUser().getName();
		case 3:
		...
		default: return StringUtils.BLANK_STRING;
		}
	}
