...
/**
 * јбстрактна€ реализаци€ стратегии выбора параметров ƒќ
 * 
...
public abstract class AbstractParamsStrategy implements DocFlowParamsStrategy {
	...
	/**
	 * установка параметров документа к отработке всеми возможными значени€ми
	 * 
	 * @param docSum
	 * @param specList
	 * @param listener
	...
	protected void silentPrepareDocumentSpecList(final BigDecimal docSum,
		...
		//проставим значени€ к отработке всем доступным
