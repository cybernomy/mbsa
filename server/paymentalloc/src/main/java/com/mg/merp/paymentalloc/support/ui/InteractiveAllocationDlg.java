		...
		table = new DefaultTableController(new AbstractTableModel() {
			...
			public Object getValueAt(int row, int column) {
				...
				switch (column) {
					...
					case 1: return item.getCName();
					case 2: return item.getMCode();
					case 3: return item.getCQty();
					case 4: return item.getAQty();
					case 5: return item.getCSumma();
					case 6: return item.getASumma();
				}
				return null;
			}
