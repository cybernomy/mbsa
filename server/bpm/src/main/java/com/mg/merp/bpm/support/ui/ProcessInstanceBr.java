	...
	public ProcessInstanceBr() {
		table = new DefaultTableController(new ColumnsTableModel() {
			...
			public Object getValueAt(int row, int column) {
				...
				switch (column) {
				case 0: return processInstance.getId();
				case 1: return processInstance.getStart();
				case 2: return processInstance.getEnd();
				case 3: return MiscUtils.getBooleanTextRepresentation(processInstance.isSuspended());
				}
				return null;
			}
