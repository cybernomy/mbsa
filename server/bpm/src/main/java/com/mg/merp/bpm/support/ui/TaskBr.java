...
/**
 *  онтроллер формы списка задач дл€ пользовател€ или группы пользователей
 * 
	...
	public TaskBr() {
		...
		table = new DefaultTableController(new ColumnsTableModel() {
			...
			public Object getValueAt(int row, int column) {
				...
				case 4: return task.getCreate();
				case 5: return task.getStart();
				case 6: return MiscUtils.getBooleanTextRepresentation(task.isSuspended());
				}
				return null;
			}
