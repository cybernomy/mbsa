...
/**
 *  онтроллер диалога установки/сброса прав дл€ всех бизнес-компонентов модул€
 * 
...
public class PermissionForSubsystemBusinessObjectsDlg extends DefaultDialog {
	...
	/**
	 * «апустить диалог на показ
	 * @param moduleName - наименование модул€
	 */
	...
	/**
	 * ѕолучить список выбранных методов
	...
	/**
	 * ѕолучить признак установки/сброса прав
	 * @return <code>true</code> - установка прав; <code>false</code> - во всех остальных случа€х
	 */
