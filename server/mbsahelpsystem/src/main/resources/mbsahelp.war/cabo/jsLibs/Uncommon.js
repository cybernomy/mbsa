    ...
    for (i = 0; i < a0.length; i++) {
        ...
        if (a1 == this.dataBeanId) {
            ...
            if (document.getElementById(this.beanId).contentWindow != undefined) {
                if (this.mode == "TEXT_MODE") {
                    a2.value =
                        document.getElementById(this.beanId).contentWindow.document.body.innerText;
                } else {
                    a2.value =
...
function _insertImageTag(a0) {
    ...
    if (this.browserFlag == "IE_Win") {
        ...
        if (a0 && a0 != "http://") {
            if (document.getElementById(this.beanId).contentWindow.document.selection.type
                == "None") {
        ...
        if ((a0 != null)
            && (a0 != "")
            && a0 != "http://") {
            document.getElementById(this.beanId).contentWindow.document.execCommand('InsertImage',
                                                                                    false, a0);
        }
    }
}
...
function _getColorFieldFormat(a0) {
    var a1 = a0.name;
    if (a1 && _cfs) {
        var a2 = _cfs[a1];
        var a3 = _cfts[a1];
...
function _wmlPatternFormat(a0) {
    return a0;
}
function _wmlPatternParse(a0) {
...
function _orderTopBottomList(a0,
                             a1,
                             a2) {
    if (a2 == (void 0)) {
        a2 = _findFormNameContaining(a1);
...
function _getSelectedIndexes(a0,
                             a1) {
...
function _findFormNameContaining(a0) {
...
function _getListName(a0,
                      a1) {
    var a2 = (a1) ? a0 + ":leading" :
             a0 + ":trailing";
    return a2;
}
function _resetItems(a0,
                     a1) {
    if (a1 == (void 0)) {
...
function _getSelectedItemCount(a0) {
    if (a0 == (void 0)) {
        a0 = true;
    }
    var a1 = _getListName(this.shuttleName, a0);
...
function _deleteItemByValue(a0,
                            a1) {
    if (a1 == (void 0)) {
        return;
    }
...
function _deleteSelectedItems(a0) {
    if (a0 == (void 0)) {
        a0 = true;
    }
    var a1 = _getListName(this.shuttleName, a0);
...
function _rgbColorParseImpl(a0,
                            a1) {
    var a2 = new Object();
    a2.currIndex = 0;
    a2.parseString = a0;
...
function _cfoAccumulateNumber(a0,
                              a1,
                              a2,
                              a3) {
    var a4 = a0.currIndex;
...
function _cfoGetPaddedNumber(a0,
                             a1,
                             a2,
                             a3) {
...
function _returnColorPickerValue(a0,
                                 a1) {
