...
/**
 * Ѕазовый класс BAi расчета скидок/наценок.  ласс алгоритма должен
 ...
 * Ёто значение будет прибавлено к цене спецификации дл€ получени€ итоговой цены.
 * 
 * <p>Ќапример, чтобы дать 20% скидку на цену, нужно создать следующий алгоритм:
 * <pre>
...
public abstract class DiscountAlgorithm extends AbstractBusinessAddin<Double> {
	...
	/**
	 * ¬озвращает значение, заданное пользователем в поле "—кидка/наценка на документ"
	 * 
