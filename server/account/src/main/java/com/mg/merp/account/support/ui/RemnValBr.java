...
public class RemnValBr extends AbstractPlainBrowseFormWithTurn {
	...
	protected String createQueryText() {
		...
		break;
		case 2: whereText.append("and (ra.remnendnat < 0)"); //$NON-NLS-1$
		break;
		case 3: whereText.append("and (ra.remnendnat = 0)"); //$NON-NLS-1$
		break;
		case 4: whereText.append("and (ra.remnendnat <> 0)"); //$NON-NLS-1$
		break;
		}
