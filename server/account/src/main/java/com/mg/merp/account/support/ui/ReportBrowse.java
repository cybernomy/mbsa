...
/**
 * Контроллер формы списка отчетов для сериса MERP/ACCOUNT/BALANCEFORMS
 *
 * @author leonova
 * @author Oleg V. Safonov
 * @version $Id: ReportBrowse.java,v 1.1 2009/02/26 14:08:18 safonov Exp $
 */
public class ReportBrowse extends AbstractForm {
  ...
  private final static String SERVICE_NAME = "MERP/ACCOUNT/BALANCEFORMS";
