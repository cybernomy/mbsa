...
/**
 * Вспомогательный класс для отображения формы списка образцов банковских документов
 *
 * @author leonova
 * @version $Id: BankDocumentModelMaintenanceEJBQLTableModel.java,v 1.1 2006/09/12 11:28:01 leonova
 *          Exp $
 */
