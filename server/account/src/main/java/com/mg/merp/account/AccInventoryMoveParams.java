...
public class AccInventoryMoveParams implements Serializable {
	 ...
	 * 				- счет учета ОС
	 * @param anl1
	 * 				- аналитика 1-го уровня счета учета ОС
	 * @param anl2
	 * 				- аналитика 2-го уровня счета учета ОС
	 * @param anl3
	 * 				- аналитика 3-го уровня счета учета ОС
	 * @param anl4
	 * 				- аналитика 4-го уровня счета учета ОС
	 * @param anl5
	 * 				- аналитика 5-го уровня счета учета ОС
	 * @param accKt
	 * 				- счет учета начисленной амортизации
	 * @param anlKt1
	 * 				- аналитика 1-го уровня счет учета начисленной амортизации
	 * @param anlKt2
	 * 				- аналитика 2-го уровня счет учета начисленной амортизации
	 * @param anlKt3
	 * 				- аналитика 3-го уровня счет учета начисленной амортизации
	 * @param anlKt4
	 * 				- аналитика 4-го уровня счет учета начисленной амортизации
	 * @param anlKt5
	 * 				- аналитика 5-го уровня счет учета начисленной амортизации
	 * @param folder
