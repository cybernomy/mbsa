 ...
 */
public class InternalInvoiceHeadModelBr extends DocumentModelBrowseForm {

  public InternalInvoiceHeadModelBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", InternalInvoiceHeadModelServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(InternalInvoiceHeadModelServiceLocal.FOLDER_PART);
  }
