...
/**
 * Класс для передачи параметров в метод {@link #revaluate()} сервиса бизнес-компонента "Инвентарная
 * картотека"
 *
...
public class AccRevaluateParams implements Serializable {
   ...
   * @param kind             - признак: 0 - фактор, 1 - до суммы, 2 - на сумму
   * @param value            - значение по признаку
   ...
   * @param isOverestimation - <code>false</code> - переоценка, <code>true</code> - дооценка
   */
