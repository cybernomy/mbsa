...
public class RemnDbKtBr extends AbstractPlainBrowseFormWithTurn {
	...
	protected String createQueryText() {
		...
		break;
		case 2: whereText.append("and ((ra.REMNENDNATDB - ra.REMNENDNATKT) < 0)"); //$NON-NLS-1$
		break;
		case 3: whereText.append("and ((ra.REMNENDNATDB - ra.REMNENDNATKT) = 0)"); //$NON-NLS-1$
		break;
		case 4: whereText.append("and ((ra.REMNENDNATDB - ra.REMNENDNATKT) <> 0)"); //$NON-NLS-1$
		break;
		}
		...
		case ORACLE: return StringUtils.format(INIT_QUERY_TEXT_FOR_ORACLE, fields, periodId1, periodId2, accountId, whereText.toString());
