 ...
 */
public class BankDocumentModelOtherBr extends BankDocumentModelBrowseForm {
  private final String INIT_QUERY_TEXT = "select %s from BankDocumentModel dhm %s %s";

  public BankDocumentModelOtherBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", BankDocumentModelOtherServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(BankDocumentModelOtherServiceLocal.FOLDER_PART);
  }
