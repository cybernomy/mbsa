...
/**
 * Ѕизнес-компонент "¬едомость начислени€ амортизации"
 * 
 * @author leonova
...
public interface AmortizationServiceLocal extends com.mg.framework.api.DataBusinessObjectService<Amortization, Integer> {
	...
	/**
	 * —оздание хоз. операций по партии амортизаций
	 * 
	 * @param batch
	 * 			- служебное поле у амортизации(номер партии)
	 * @param folder
	 * 			- папка дл€ создани€ хоз. операции
	 */
   void commitAmortization(Integer batch, Folder folder);

   /**
    * ќткат создани€ хоз. операций по парти€м амортизаций
    * 
    * @param batch
	* 	    	- служебное поле у амортизации(номер партии)
    */
