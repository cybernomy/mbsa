 ...
 */
public class CashDocumentModelOutBr extends CashDocumentModelBrowseForm {
	private final String INIT_QUERY_TEXT = "select %s from CashDocumentModel dhm %s %s";
	
	public CashDocumentModelOutBr() throws Exception {
		super();
		folderService =  (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
		treeUIProperties.put("FolderType", CashDocumentModelOutServiceLocal.FOLDER_PART);
	}
	...
	protected TreeNode loadFolders() throws ApplicationException {
		return ReferenceUtils.loadFolderHierarchy(CashDocumentModelOutServiceLocal.FOLDER_PART);
	}
