...
public class WarehouseBatchTableModel extends AbstractTableModel {
  ...
  /**
   * Список объектов, содержащих в себе количество, подлежащее списанию в двух ЕИ. Связан с
   * batchesList по индексу элемента
   */
   ...
   * Наполнение модели
   *
   * @param batchesList Список доступных складских партий
   */
  ...
  /**
   * @return список объектов, содержащий в себе количество списываемых позиций в двух ЕИ
   */
