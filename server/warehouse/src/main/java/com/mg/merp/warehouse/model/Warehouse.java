...
/**
 * ћодель бизнес-компонента "—клады"
 * 
...
public class Warehouse extends OrgUnit implements Serializable {
	...
	/**
	 * закрыть склад дл€ фактического движени€
	 */
	...
	/**
	 * BAi рассчЄта цены прихода складской партии
	 */
	private com.mg.merp.baiengine.model.Repository batchPriceBAi;

	/**
	 * BAi cтратегии списани€
	 */
	...
	/**
	 * ѕолучить BAi рассчЄта цены прихода складской партии
	 */
