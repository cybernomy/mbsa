...
public class InventoryActHeadServiceBean extends AbstractWarehouseDocument<InventoryActHead, Integer, DocumentPattern, InventoryActSpecServiceLocal> implements InventoryActHeadServiceLocal {
   ...
   *
   * @param docSpecs                 список спецификаций
   * @param currencyPrecRoundContext контекст округления
   * @param molInventoryKind         объединять по мол-ам
   * @param priceInventoryKind       объединять по ценам
   */
   ...
   *
   * @param inventoryActSpecInfo - информация о номеклатуре для создания спецификации акта
   *                             инвентаризации
