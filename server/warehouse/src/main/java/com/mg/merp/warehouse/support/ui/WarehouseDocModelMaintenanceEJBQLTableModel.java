...
/**
 * ¬спомогательный класс дл€ отображени€ формы списка образцов складких документов
 * 
 * @author leonova
 * @version $Id: WarehouseDocModelMaintenanceEJBQLTableModel.java,v 1.1 2006/09/12 10:52:39 leonova Exp $ 
 */
