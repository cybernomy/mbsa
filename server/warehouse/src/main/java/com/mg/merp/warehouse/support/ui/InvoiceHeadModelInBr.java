 ...
 * @version $Id: InvoiceHeadModelInBr.java,v 1.4 2006/09/12 10:50:42 leonova Exp $
 */
public class InvoiceHeadModelInBr extends DocumentModelBrowseForm {
	private final String INIT_QUERY_TEXT = "select %s from InvoiceHeadModel dhm %s %s";
	
	public InvoiceHeadModelInBr() throws Exception {
		super();
		folderService =  (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
		treeUIProperties.put("FolderType", InvoiceHeadModelInServiceLocal.FOLDER_PART);
	}
	...
	protected TreeNode loadFolders() throws ApplicationException {
		return ReferenceUtils.loadFolderHierarchy(InvoiceHeadModelInServiceLocal.FOLDER_PART);
	}
