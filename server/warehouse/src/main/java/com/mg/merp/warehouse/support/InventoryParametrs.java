...
public class InventoryParametrs {
   ...
   * @param molKind          правило формирования строк по партиям: 0 - одна строка ТМЦ по одному
   *                         МОЛ-у склада инвентаризации; 1 - одна строка ТМЦ по всем МОЛ-ам склада
   *                         инвентаризации;
   * @param isIncludeEmpty   признак включения позиций с нулевым остатком
   * @param isDeleteSpecList признак удаления спецификаций из акта инвентаризации перед
   *                         инвентаризацией
   */
