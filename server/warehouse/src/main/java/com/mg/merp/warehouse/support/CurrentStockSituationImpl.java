...
/**
 * –еализаци€ сервиса рассчЄта количества на складах
 * 
...
public class CurrentStockSituationImpl implements CurrentStockSituation {
	...
	/**
	 * реализаци€ получени€ текущего состо€ни€ склада
	 * 
	 * @param warehouse
	 * @param mol
	 * @param catalog
	...
	private List<StockSituationValues> internalGetSituation(Integer catalogId) {
		//поиск всех  —”, доступных пользователю, дл€ данной позиции каталога
	...
	/**
	 * расчет текущего состо€ни€ по позиции склада
	 * 
	 * @param stockCard
	 * @return
	 */
