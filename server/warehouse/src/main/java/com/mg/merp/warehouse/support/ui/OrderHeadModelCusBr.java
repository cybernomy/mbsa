 ...
 */
public class OrderHeadModelCusBr extends WarehouseDocumentModelBrowseForm {
  private final String INIT_QUERY_TEXT = "select %s from OrderHeadModel dhm %s %s";

  public OrderHeadModelCusBr() throws Exception {
    super();
    folderService = (DataBusinessObjectService) ApplicationDictionaryLocator.locate().getBusinessService("merp/reference/Folder");
    treeUIProperties.put("FolderType", OrderHeadModelCusServiceLocal.FOLDER_PART);
  }
  ...
  protected TreeNode loadFolders() throws ApplicationException {
    return ReferenceUtils.loadFolderHierarchy(OrderHeadModelCusServiceLocal.FOLDER_PART);
  }
