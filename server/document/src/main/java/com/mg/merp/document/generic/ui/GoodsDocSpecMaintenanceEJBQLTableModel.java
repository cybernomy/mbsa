...
public abstract class GoodsDocSpecMaintenanceEJBQLTableModel extends
  ...
  /**
   * получить имя модели спецификации документа, может быть переопределен в наследниках, если у
   * спецификации есть собственная модель расширяющая {@link com.mg.merp.document.model.DocSpec}
   *
   * @return имя модели
   */
  ...
  /**
   * создание текста EJBQL запроса для получения информации отображаемой в модели таблицы, как
   * правило не требует переопределения в наследниках
   *
