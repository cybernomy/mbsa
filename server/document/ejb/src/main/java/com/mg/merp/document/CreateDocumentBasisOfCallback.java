...
/**
 * Объект обратного вызова для перехвата обработки создания документа, в качестве реализации
 * рекомендуется использовать экземпляр класса наследованного от {@link
 * com.mg.merp.document.generic.AbstractCreateDocumentBasisOfCallback}
 *
...
public interface CreateDocumentBasisOfCallback extends Serializable {
  ...
  /**
   * вызывается при обработки заголовка документа, возможна установка атрибутов объекта
   * <code>dstDoc</code>
   *
