...
/**
 * Контроллер формы поиска бизнес-компонента "Каталог". Устанавливает в спецификации атрибуты
 * 'Единица измерения в основной ЕИ' 'Единица измерения в дополнительной ЕИ'из выбранной каталожной
 * позиции
 *
