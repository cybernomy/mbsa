...
/**
 * Поиск стандартных (унаследованных от {@link com.mg.merp.document.model.DocHeadModel
 * DocHeadModel}) образов документов. Содержит контекст импорта из следующих параметров: {@link
 * com.mg.merp.document.model.DocSection DocSection} - раздел документа, {@link
 * com.mg.merp.core.model.Folder DocModelFolder} - папка образца (если <code>null</code> то поиск
 * будет производиться без учета папки)
 *
