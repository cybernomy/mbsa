...
public class ContextFilter implements Filter {
  /**
   * имя параметра содержащего идентификатор контекста приложения, переданного из merp, должно
   * соотвествовать {@link com.mg.merp.report.support.RptEngineImpl#VIEWER_CONTEXT_PARAM_NAME}
   */
