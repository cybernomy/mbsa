...
/**
 * @ejb.bean name = "DocumentService" type = "Stateless" view-type = "local" local-jndi-name =
 * "merp/crm/DocumentService" description = "DocumentRest" display-name = "DocumentRest"
 ...
 * "com.mg.merp.crm.support.DocumentDomainImpl"
